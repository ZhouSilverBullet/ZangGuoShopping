package cn.com.zangguo.shopping.utils;
...
public class NetworkUtils {
    ...
    public static boolean isAvailableByPing() {
        ...
        if (result.errorMsg != null) {
            Log.d("NetworkUtils", "isAvailableByPing errorMsg" + result.errorMsg);
        }
        if (result.successMsg != null) {
            Log.d("NetworkUtils", "isAvailableByPing errorMsg" + result.successMsg);
        }
        return ret;
    }
